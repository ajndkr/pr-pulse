...
No headers are required in the summary. Mention the number of pull requests merged over the target period, mentioning only the elapsed days/weeks. Add a clap emoji at the end of this first line.
...
For all other changes, mention them in a single paragraph of maximum 3 lines. Add a raised hands emoji at the end of this paragraph.
